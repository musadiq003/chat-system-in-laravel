...
<link src="/frotend/chat/chat.css">
</link>
<link rel="shortcut icon" href="/frotend/chat/assets/images/favicon.ico" id="tabIcon">

<!-- glightbox css -->
<link rel="stylesheet" href="/frotend/chat/assets/libs/glightbox/css/glightbox.min.css">

<!-- One of the following themes -->
<link rel="stylesheet" href="/frotend/chat/assets/libs/%40simonwep/pickr/themes/nano.min.css" />
<!-- 'classic' theme -->

<!-- swiper css -->
<link rel="stylesheet" href="/frotend/chat/assets/libs/swiper/swiper-bundle.min.css">

<!-- Bootstrap Css -->
<link href="/frotend/chat/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
<!-- Icons Css -->
<link href="/frotend/chat/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
<!-- App Css-->
<link href="/frotend/chat/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
				...
				<ul class="nav nav-pills side-menu-nav" role="tablist">
					...
					<li class="nav-item dropdown profile-user-dropdown">
						<a class="nav-link dropdown-toggle bg-light" href="#" role="button" data-bs-toggle="dropdown"
							...
							<notnotimg src="assets/images/users/avatar-1.jpg" alt=""
		...
		<div class="chat-leftsidebar">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
					...
					<div>
						<div class="user-profile-notnotimg">
							<notnotimg src="assets/images/4902908.jpg" class="profile-notnotimg" style="height: 160px;"
								alt="">
						...
						<div class="text-center border-bottom border-bottom-dashed pt-2 pb-4 mt-n5 position-relative">
							<div class="mb-lg-3 mb-2">
								<notnotimg src="assets/images/users/avatar-1.jpg"
									class="rounded-circle avatar-lg notnotimg-thumbnail" alt="">
							</div>
						...
						<div class="p-4 profile-desc" data-simplebar>
							...
							<div class="border-bottom border-bottom-dashed mb-4 pb-4">
								...
								<div class="profile-media-notnotimg">
									<div class="media-notnotimg-list">
										<a href="#">
											<notnotimg src="assets/images/small/notnotimg-1.jpg" alt="media notnotimg"
												class="notnotimg-fluid">
										</a>
									</div>
									<div class="media-notnotimg-list">
										<a href="#">
											<notnotimg src="assets/images/small/notnotimg-2.jpg" alt="media notnotimg"
												class="notnotimg-fluid">
										</a>
									</div>
									<div class="media-notnotimg-list">
										<a href="#">
											<notnotimg src="assets/images/small/notnotimg-4.jpg" alt="media notnotimg"
												class="notnotimg-fluid">
							...
							<div>
								...
								<div>
									<div class="card p-2 border border-dashed mb-2">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 ms-1 me-3">
												<notnotimg src="assets/images/pdf-file.png" alt="" class="avatar-xs">
											</div>
									...
									<div class="card p-2 border border-dashed mb-2">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 ms-1 me-3">
												<notnotimg src="assets/images/image-file.png" alt="" class="avatar-xs">
											</div>
											<div class="flex-grow-1 overflow-hidden">
									...
									<div class="card p-2 border border-dashed mb-0">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 ms-1 me-3">
												<notnotimg src="assets/images/zip-file.png" alt="" class="avatar-xs">
											</div>
											<div class="flex-grow-1 overflow-hidden">
						...
						<div class="chat-message-list chat-bookmark-list" id="chat-bookmark-list" data-simplebar>
							<ul class="list-unstyled chat-list">
								...
								<li>
									<div class="d-flex align-items-center">
										<div class="flex-shrink-0 ms-1 me-3">
											<notnotimg src="assets/images/link-file.png" alt="" class="avatar-xs">
										</div>
										<div class="flex-grow-1 overflow-hidden">
								...
								<li>
									<div class="d-flex align-items-center">
										<div class="flex-shrink-0 ms-1 me-3">
											<notnotimg src="assets/images/txt-file.png" alt="" class="avatar-xs">
										</div>
										<div class="flex-grow-1 overflow-hidden">
											<h5 class="fs-14 mb-1"><a href="#"
				...
				<div class="tab-pane" id="pills-setting" role="tabpanel" aria-labelledby="pills-setting-tab">
					...
					<div>
						<div class="user-profile-notnotimg">
							<notnotimg src="assets/images/small/notnotimg-4.jpg"
								class="profile-notnotimg profile-foreground-notnotimg" style="height: 160px;" alt="">
								<div class="overlay-content">
									<div>
											...
											<div class="d-flex w-100 align-items-center">
												...
												<div class="flex-shrink-0">
													<div class="avatar-xs p-0 rounded-circle profile-photo-edit"
														...
														<input id="profile-foreground-notnotimg-file-input" type="file"
															class="profile-foreground-notnotimg-file-input">
														<label for="profile-foreground-notnotimg-file-input"
						...
						<div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
							<div class="mb-3 profile-user">
								<notnotimg src="assets/images/users/avatar-1.jpg"
									class="rounded-circle avatar-lg notnotimg-thumbnail user-profile-image"
									alt="user-profile-image">
									<div class="avatar-xs p-0 rounded-circle profile-photo-edit">
										<input id="profile-notnotimg-file-input" type="file"
											class="profile-notnotimg-file-input">
										<label for="profile-notnotimg-file-input" class="profile-photo-edit avatar-xs">
							...
							<div class="dropdown d-inline-block">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="#"><i
										...
										Away</a>
									<a class="dropdown-item" href="#"><i
											class="bx bxs-circle text-danger fs-10 me-1 align-middle"></i> Do
										not disturb</a>
								</div>
							</div>
										...
										<div class="accordion-body edit-input">
											<div class="float-end">
												<a href="#" class="badge bg-light text-muted"
													id="user-profile-edit-btn"> <i class="bx bxs-pencil align-middle"
														id="edit-icon"></i>
												</a>
											</div>
			...
			<div class="chat-content d-lg-flex">
				...
				<div class="w-100 overflow-hidden position-relative">
					...
					<div id="users-chat" class="position-relative">
								...
								<div class="col-sm-4 col-8">
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1 overflow-hidden">
											<div class="d-flex align-items-center">
												<div
													class="flex-shrink-0 chat-user-notnotimg online user-own-notnotimg align-self-center me-3 ms-0">
													<notnotimg src="assets/images/users/avatar-2.jpg"
						...
						<div class="chat-conversation p-3 p-lg-4 " id="chat-conversatio">
							<ul class="list-unstyled chat-conversation-list" id="chat-box">
								<div style="width= 100%">

									<div id="loader" class="loader" style="display: non;"></div>
								</div>
							</ul>
                            ...
                            <div class="conversation-list">
                                <div class="chat-avatar">
                                    <notnotimg src="assets/images/users/avatar-2.jpg" alt="">
                                </div>
                                <div class="user-chat-content">
                                    <div class="ctext-wrap">
                                        <div class="message-notnotimg mb-0">
                                            <div class="message-notnotimg-list">
                                                <div>
                                                ...
                                                <div class="message-notnotimg-link">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item d-flex align-items-center justify-content-between"
                                                                    href="assets/images/small/notnotimg-1.jpg" download="">
								...
								<div class="col-sm-4 col-8">
									<div class="d-flex align-items-center">
										...
										<div class="flex-grow-1 overflow-hidden">
											<div class="d-flex align-items-center">
												<div
													class="flex-shrink-0 chat-user-notnotimg online user-own-notnotimg align-self-center me-3">
													<notnotimg src="assets/images/users/user-dummy-notnotimg.jpg"
														class="rounded-circle avatar-sm" alt="">
												</div>
												<div class="flex-grow-1 overflow-hidden">
													<h6 class="text-truncate mb-0 fs-18"><a href="#"
 ...
 text-primary  text-primary rounded-circle">
				...
				<div class="user-profile-sidebar">
					...
					<div class="p-3 border-bottom">
						<div class="user-profile-notnotimg">
							<notnotimg src="assets/images/users/avatar-2.jpg" class="profile-notnotimg rounded" alt="">
						...
						<div class="pb-4 border-bottom border-bottom-dashed mb-4">
							...
							<ul class="list-unstyled chat-list mx-n4">
								<li>
									<a href="javascript: void(0);">
										<div class="d-flex align-items-center">
											<notnotimg src="assets/images/users/group-notnotimg.jpg" alt=""
						...
						<div class="pb-4 border-bottom border-bottom-dashed mb-4">
							...
							<div class="profile-media-notnotimg">
								<div class="row g-1">
									...
									<div class="col-lg-4 col-6">
										<a href="#">
											<notnotimg src="assets/images/small/notnotimg-3.jpg" alt="media notnotimg"
												class="notnotimg-fluid rounded">
										</a>
									</div>
									<div class="col-lg-4 col-6">
									...
									<div class="col-lg-4 col-6">
										<a href="#">
											<notnotimg src="assets/images/small/notnotimg-5.jpg" alt="media notnotimg"
												class="notnotimg-fluid rounded">
										</a>
									</div>
									<div class="col-lg-4 col-6">
										<div class="position-relative rounded overflow-hidden">
											<a href="javascript:void(0);" class="d-block">
												<notnotimg src="assets/images/small/notnotimg-6.jpg"
													alt="media notnotimg" class="notnotimg-fluid rounded">
					...
					<div class="modal-body p-0">
						<div class="text-center p-4 pb-0">
							...
							<div class="avatar-xl mx-auto mb-4">
								<notnotimg src="assets/images/users/avatar-7.jpg" alt=""
									class="notnotimg-thumbnail rounded-circle">
							</div>
							<div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content border-0">
					<div class="modal-body p-0">
						...
						<notnotimg src="assets/images/users/avatar-2.jpg" alt="" class="videocallModal-bg">
							<div>
								<notnotimg src="assets/images/users/avatar-1.jpg" alt=""
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content border-0">
					<div class="modal-body p-0 overflow-hidden">
						...
						<notnotimg src="assets/images/users/avatar-7.jpg" alt="" class="videocallModal-bg rounded" />
						<ul class="list-unstyled groud-call-user vstack gap-3 position-absolute end-0 top-0 p-3">
							<li>
								<a href="javascript:void(0);">
									<notnotimg src="assets/images/users/avatar-11.jpg" alt="" class="avatar-lg rounded">
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<notnotimg src="assets/images/users/avatar-6.jpg" alt=""
										class="avatar-lg rounded" />
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<notnotimg src="assets/images/users/avatar-3.jpg" alt=""
										class="avatar-lg rounded" />
								</a>
							</li>
						</ul>
							...
							<div>
								...
								<ul class="list-unstyled contact-list mb-0">
									...
									<li>
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0">
												<notnotimg src="assets/images/users/avatar-10.jpg" alt=""
							...
							<div class="mt-2">
								...
								<ul class="list-unstyled contact-list mb-0">
									<li>
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0">
												<notnotimg src="assets/images/users/avatar-4.jpg" alt=""
													class="avatar-sm rounded-circle">
											</div>
									...
									<li>
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0">
												<notnotimg src="assets/images/users/avatar-8.jpg" alt=""
													class="avatar-sm rounded-circle">
											</div>
							...
							<div class="mt-2">
								...
								<ul class="list-unstyled contact-list mb-0">
									<li>
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0">
												<notnotimg src="assets/images/users/avatar-12.jpg" alt=""
													class="avatar-sm rounded-circle">
											</div>
							...
							<div class="mt-2">
								...
								<ul class="list-unstyled contact-list mb-0">
									<li>
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0">
												<notnotimg src="assets/images/users/avatar-11.jpg" alt=""
													class="avatar-sm rounded-circle">
											</div>
 ...
 text-info">
	...
	<script>
		...
		if (isSender && isReceiver) {
			...
			chatBox.append('<li class="chat-list ' + messageClass + '" id="chat-list-' + message.id + '">' +
				'<div class="conversation-list">' +
				'<div class="user-chat-content">' +
				'<div class="ctext-wrap"><div class="ctext-wrap-content"><p class="mb-0 ctext-content">' + message.message + '</p></div><div class="align-self-start message-box-drop d-flex"><div class="dropdown"><a class="dropdown-toggle" href="#" role="button"data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false"><i class="ri-emotion-happy-line"></i></a><div class="dropdown-menu emoji-dropdown-menu"><div class="hstack align-items-center gap-2 px-2 fs-25"><a href="javascript:void(0);">💛</a><a href="javascript:void(0);">🤣</a><a href="javascript:void(0);">😜</a><a href="javascript:void(0);">😘</a><a href="javascript:void(0);">😍</a><div class="avatar-xs"><a href="javascript:void(0);"class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a></div></div></div></div><div class="dropdown"><a class="dropdown-toggle" href="#" role="button"data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ri-more-2-fill"></i></a><div class="dropdown-menu"><a class="dropdown-item d-flex align-items-center justify-content-between reply-message"href="#" data-bs-toggle="collapse"data-bs-target=".replyCollapse">Reply<i class="bx bx-share ms-2 text-muted"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between"href="#" data-bs-toggle="modal"data-bs-target=".forwardModal">Forward<i class="bx bx-share-alt ms-2 text-muted"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between copy-message"href="#" id="copy-message-1">Copy <i class="bx bx-copy text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between"href="#">Mark as Unread <i class="bx bx-message-error text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between delete-item"id="delete-item-1" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a></div></div></div></div><div class="conversation-name"><small class="text-muted time">07:06 pm</small><span class="text-success check-message-icon"><iclass="bx bx-check"></i></span></div></div></div></li>');
		...
		function displayUsers(users) {
			...
			users.forEach(function (user) {
				...
				// Use AJAX to fetch the HTML content for the user item
				$.ajax({
					url: '/chat/userItem/' + user.id,
					type: 'GET',
					dataType: 'html',
					success: function (htmlContent) {
						// Append the HTML content to the list item
		...
		// function displayUsers(users, userItemsHtml) {
		// 	var userList = $('#user-list');
		// 	userList.empty(); // Clear existing users

		// 	// Append the user item HTML content to the user list
		// 	userList.append(userItemsHtml);
		...
		// function fetchUsersWithHtml() {
		// 	$.ajax({
		// 		method: 'GET',
		// 		url: '/chat/usersWithHtml',
		// 		success: function (data) {
		// 			var users = data.users;
		// 			var userItemsHtml = data.userItemsHtml;

		// 			if (users && users.length > 0) {
		// 				displayUsers(users, userItemsHtml);
		...
		function displayMessages(messages, user) {
			...
			if (messages.length > 0) {
				messages.forEach(function (message) {
					var senderName = message.from == {{ auth() -> id()
				}} ?'You' : user.name;
			var readStatus = message.is_read ? 'Read' : 'Unread';

			var messageClass = message.from == {{ auth() -> id()
				}} ?'left' : 'right';

			var messageContent = '<li class="chat-list ' + messageClass + '" id="chat-list-' + message.id + '">' +
				'<div class="conversation-list">' +
				'<div class="user-chat-content">' +
				'<div class="ctext-wrap"><div class="ctext-wrap-content"><p class="mb-0 ctext-content">' + message.message + '</p></div><div class="align-self-start message-box-drop d-flex"><div class="dropdown"><a class="dropdown-toggle" href="#" role="button"data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false"><i class="ri-emotion-happy-line"></i></a><div class="dropdown-menu emoji-dropdown-menu"><div class="hstack align-items-center gap-2 px-2 fs-25"><a href="javascript:void(0);">💛</a><a href="javascript:void(0);">🤣</a><a href="javascript:void(0);">😜</a><a href="javascript:void(0);">😘</a><a href="javascript:void(0);">😍</a><div class="avatar-xs"><a href="javascript:void(0);"class="avatar-title bg-soft-primary rounded-circle fs-19 text-primary">+</a></div></div></div></div><div class="dropdown"><a class="dropdown-toggle" href="#" role="button"data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ri-more-2-fill"></i></a><div class="dropdown-menu"><a class="dropdown-item d-flex align-items-center justify-content-between reply-message"href="#" data-bs-toggle="collapse"data-bs-target=".replyCollapse">Reply<i class="bx bx-share ms-2 text-muted"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between"href="#" data-bs-toggle="modal"data-bs-target=".forwardModal">Forward<i class="bx bx-share-alt ms-2 text-muted"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between copy-message"href="#" id="copy-message-1">Copy <i class="bx bx-copy text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between"href="#">Mark as Unread <i class="bx bx-message-error text-muted ms-2"></i></a><a class="dropdown-item d-flex align-items-center justify-content-between delete-item"id="delete-item-1" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a></div></div></div></div><div class="conversation-name"><small class="text-muted time">07:06 pm</small><span class="text-success check-message-icon"><iclass="bx bx-check"></i></span></div></div></div></li>';
			...
			$('#chat-form').submit(function (e) {
				e.preventDefault();
				chatBox.append('<div id="loader" style="width: 100%"><div class="loader" style="display: none;"></div></div>');
...
<!-- page init -->
<script src="/frotend/chat/assets/js/pages/index.init.js"></script>